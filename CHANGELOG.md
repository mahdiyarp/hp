...
- 2025-12-15: Backend PApi: افزودن بای‌پس توسعه/دمو برای OTP/SMS (DEV_FEATURES_ENABLED/DEMO_ALLOW_OTP_NO_SMS) جهت جلوگیری از خطای 502 در نبود API Key. لاگ رویدادهای بای‌پس به `logs/papi.jsonl` افزوده شد.
