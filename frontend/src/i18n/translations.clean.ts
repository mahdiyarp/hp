...
export const fa = {
  ...
  please_fill_required_fields: 'لطفاً فیلدهای ضروری را کامل کنید',

  // Dashboard
  dashboard: 'داشبورد',
  dashboard_desc: 'نمای کلی و تحلیل سریع تراکنش‌ها',
  smart_date: 'تاریخ هوشمند',
  fiscal_year: 'سال مالی',
  today: 'امروز',
  this_month: 'این ماه',
  last_seven_days: 'هفت روز اخیر',
  ...
  manage_customer_groups_description: 'گروه‌بندی مشتریان برای سازماندهی و گزارش‌گیری بهتر',
  create_group: 'ایجاد گروه',
  edit_group: 'ویرایش گروه',
  group_name: 'نام گروه',
  group_description: 'توضیح گروه',
  is_shared: 'اشتراک‌گذاری',
  no_groups_yet: 'هنوز گروهی ایجاد نشده است',
  no_members_yet: 'هنوز عضوی افزوده نشده است',
  add_member: 'افزودن عضو',
  select_person: 'انتخاب شخص',
  members: 'اعضا',
  shared: 'اشتراکی',
  private: 'خصوصی',
  please_select_group_and_member: 'لطفاً گروه و شخص را انتخاب کنید',
  name: 'نام',
  
  // ICC Shop
  integration: 'یکپارچه‌سازی',
  icc_shop: 'فروشگاه ICC',
  registration: 'ثبت‌نام',
  active_module: 'ماژول فعال',
  module_not_found: 'ماژول پیدا نشد',
  loading_system: 'در حال راه‌اندازی سیستم...',
  command_pad: 'محل فرمان',
  activity_counter: 'شمارنده فعالیت',
  sales_trend: 'روند فروش',
  latest_invoices: 'آخرین فاکتورها',
  inventory_snapshot: 'نمای کلی انبار',
  aging_inventory: 'موجودی راکد',
  checks_due: 'چک‌های سررسید',
  fx_rates: 'نرخ ارز',
  crypto: 'رمزارز',
  categories: 'دسته‌ها',
  centers: 'مراکز',
  ...
  operation_failed: 'عملیات با خطا روبه‌رو شد',
...
export const ar = {
  ...
  dashboard_desc: 'نظرة عامة وتحليل سريع للمعاملات',
  smart_date: 'التاريخ الذكي',
  ...
  password: 'كلمة السر',
  remember_me: 'تذكرني',
  otp_code: 'رمز لمرة واحدة',
  phone_login: 'تسجيل الدخول برقم الهاتف',
  mobile_number: 'رقم الهاتف المحمول',
  invalid_credentials: 'اسم المستخدم أو كلمة السر غير صحيح',
  ...
  manage_customer_groups_description: 'إنشاء وإدارة مجموعات العملاء لتنظيم أفضل',
  create_group: 'إنشاء مجموعة',
  edit_group: 'تعديل المجموعة',
  group_name: 'اسم المجموعة',
  group_description: 'وصف المجموعة',
  is_shared: 'مشترك',
  no_groups_yet: 'لم يتم إنشاء مجموعات بعد',
  no_members_yet: 'لم يتم إضافة أعضاء بعد',
  add_member: 'إضافة عضو',
  select_person: 'اختر شخصًا',
  members: 'الأعضاء',
  shared: 'مشترك',
  private: 'خاص',
  please_select_group_and_member: 'يرجى اختيار المجموعة والعضو',
  name: 'الاسم',
  ...
  loading_system: 'جارٍ تشغيل النظام...',
  command_pad: 'لوحة الأوامر',
  activity_counter: 'عداد النشاط',
  sales_trend: 'اتجاه المبيعات',
  latest_invoices: 'أحدث الفواتير',
  inventory_snapshot: 'ملخص المخزون',
  aging_inventory: 'المخزون القديم',
  checks_due: 'الشيكات المستحقة',
