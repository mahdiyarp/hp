...
export const fa = {
  ...
  manage_customer_groups_description:
    'ع¯ط±ظˆظ‡â€Œظ‡ط§غŒ ظ…ط´طھط±غŒ ط±ط§ ط¨ط±ط§غŒ ط³ط§ط²ظ…ط§ظ†â€Œط¯ظ‡غŒ ط¨ظ‡طھط± ط§غŒط¬ط§ط¯ ظˆ ظ…ط¯غŒط±غŒطھ ع©ظ†غŒط¯',
...
export const translations = { fa, en, ar, ku } as const
