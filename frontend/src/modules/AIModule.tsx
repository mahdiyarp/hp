  ...
  return (
    ...
    <div className="space-y-6">
      ...
      <section className={`${retroPanelPadded} space-y-3`}>
        ...
        <button className={retroButton} type="button" onClick={handleProductMatch} disabled={loading.product}>
      ...
      <section className={`${retroPanelPadded} space-y-3`}>
        ...
        <button className={retroButton} type="button" onClick={handleInvoiceAnalysis} disabled={loading.invoice}>
