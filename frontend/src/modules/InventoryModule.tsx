      ...
      <section className={`${retroPanelPadded} space-y-4`}>
        ...
        <header className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <button className={`${retroButton} !bg-[#1f2e3b]`} type="button" onClick={loadProducts}>
            ...
            <button className={retroButton} type="button">ط·آ·ط¢آ·ط·آ¹ط¢آ¾ط·آ·ط¢آ¸ط£آ¢أ¢â€ڑآ¬ط¢آ ط·آ·ط¢آ·ط·آ¢ط¢آ¸ط·آ·ط·â€؛ط·آ¥أ¢â‚¬â„¢ط·آ·ط¢آ¸ط£آ¢أ¢â€ڑآ¬ط¢آ¦ط·آ·ط¢آ·ط·آ¢ط¢آ§ط·آ·ط¢آ·ط·آ¹ط¢آ¾ ط·آ·ط¢آ¸ط£آ¢أ¢â€ڑآ¬ط¢آ ط·آ·ط¢آ¸ط£آ¢أ¢â€ڑآ¬ط¢آ¦ط·آ·ط¢آ·ط·آ¢ط¢آ§ط·آ·ط·â€؛ط·آ¥أ¢â‚¬â„¢ط·آ·ط¢آ¸ط£آ¢أ¢â€ڑآ¬ط·إ’</button>
      ...
      <section className={`${retroPanelPadded} space-y-4`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-3">
          ...
          <div className="space-y-2">
            ...
            <select aria-label="تعداد در صفحه" className={`${retroInput} w-full`} value={pageSize} onChange={e => setPageSize(Number(e.target.value))}>
          ...
          <div className="flex items-center gap-2">
            ...
            <button className={retroButton} type="button" onClick={exportListToCsv}>
            ...
            <button className={retroButton} type="button" onClick={printList}>
        ...
        {filtered.length > 0 ? (
          ...
          layoutMode === 'table' ? (
            ...
            <table className="hp-table w-full border border-[#c5bca5] bg-[#faf4de] text-xs">
            ...
            <header className="flex items-center justify-between gap-3 sticky top-0 bg-[#fdf7e6] pb-3 border-b border-[#c5bca5]">
              ...
              <div className="flex gap-2">
                ...
                {movementData && (
                  ...
                  <button className={`${retroButton} !bg-[#1f2e3b]`} type="button" onClick={exportMovement}>
