      ...
      <div className="overflow-x-auto mt-3">
        <table className="min-w-full text-sm">
          ...
          <tbody>
            {items.map((t: any) => (
              <tr key={t.id} className="border-t">
                ...
                <td className="px-3 py-2">
                  <span
                    className={`hp-badge ${t.status === 'done' ? 'success' : t.status === 'doing' ? 'dark' : 'default'}`}
                  >
                    {t.status}
                  </span>
                </td>
                ...
                <td className="px-3 py-2">
                  {t.entity_type ? `${t.entity_type}#${t.entity_id}` : '-'}
                </td>
                <td className="px-3 py-2">
                  <button
            ...
            {items.length === 0 && (
              <tr>
                <td className="px-3 py-6 text-center text-[var(--primary)]/70" colSpan={6}>
