...
def _find_price_from_text(text: str) -> Optional[int]:
    if not text:
        return None
    # find numbers like 1,234,567 or ط·آ·ط·â€؛ط·آ¢ط¢آ±ط·آ·ط·â€؛ط·آ¢ط¢آ²ط·آ·ط·â€؛ط·آ¢ط¢آ³ط·آ·ط·â€؛ط·آ¢ط¢آ´ط·آ·ط·â€؛ط·آ¢ط¢آµط·آ·ط·â€؛ط·آ¢ط¢آ¶ط·آ·ط·â€؛ط·آ¢ط¢آ· and Persian digits
    ...
    for sel in selectors:
        ...
        if el:
            ...
            if text:
                break
    if not text:
        # fallback: search for text nodes with ط·آ·ط¢آ·ط·آ¹ط¢آ¾ط·آ·ط¢آ¸ط·آ«أ¢â‚¬آ ط·آ·ط¢آ¸ط£آ¢أ¢â€ڑآ¬ط¢آ¦ط·آ·ط¢آ·ط·آ¢ط¢آ§ط·آ·ط¢آ¸ط£آ¢أ¢â€ڑآ¬ط¢آ  or ط·آ·ط¢آ·ط·آ¢ط¢آ±ط·آ·ط·â€؛ط·آ¥أ¢â‚¬â„¢ط·آ·ط¢آ·ط·آ¢ط¢آ§ط·آ·ط¢آ¸ط£آ¢أ¢â€ڑآ¬أ¢â‚¬ع†
