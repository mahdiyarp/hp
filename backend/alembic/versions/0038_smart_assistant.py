...
Revision ID: 0038_smart_assistant
Revises: 0037
...
def upgrade():
    ...
    if 'smart_assistant_settings' not in inspector.get_table_names():
        op.create_table(
    ...
    if 'smart_assistant_sessions' not in inspector.get_table_names():
        op.create_table(
    ...
    if 'smart_assistant_messages' not in inspector.get_table_names():
        op.create_table(
